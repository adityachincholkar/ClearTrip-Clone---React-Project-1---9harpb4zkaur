...
function Copyright(props) {
  return (
    ...
    >
      {"Copyright © "}
      <NavLink to="/" sx={{ backgroundColor: "none" }}>
        cleartrip
      </NavLink>{" "}
...
export default function SignUp({
  ...
  const { updateShowSignUp } = authContextStore;
  ...
  const handleSignup = async (e) => {
    ...
    if (!name || !email || !password) {
      setMessage("Please, fill the required information!");
      setMessageColor("red");
      return;
    }
    ...
    try {
      ...
      setMessage("This account already exists. Please log in.");
      setMessageColor("red");
          ...
          >
            ...
            <Grid container justifyContent="flex-end">
              ...
              <p
                ...
                onClick={() => updateShowSignUp(false)}
              >
                Already have an account? Sign in
              </p>
              {/* <p
