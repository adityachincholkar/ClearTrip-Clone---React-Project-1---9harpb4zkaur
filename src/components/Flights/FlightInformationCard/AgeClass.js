...
// import "../../styles/AgeClass.css";

// const AgeClass = ({ SetnumberOfPeople }) => {
...
//                 <RemoveCircleOutlineIcon />
//               </IconButton>
//               <span className="option-count">{infants}</span>
...
const AgeClass = ({ SetnumberOfPeople }) => {
  ...
  // Effect to update total number of people whenever adults, children, or infants change
  useEffect(() => {
    const totalPeople = adults + children + infants;
    SetnumberOfPeople(totalPeople);
  }, [adults, children, infants, SetnumberOfPeople]);
